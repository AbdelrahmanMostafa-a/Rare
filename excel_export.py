...
from debt_core import FOLLOWUP_SHEET_NAME, OVERDUE_COL, build_followup_list
...
def build_excel_report(result: pd.DataFrame, meta: dict = None) -> bytes:
    """يبني ملف Excel فيه شيت 'معلومات التقرير' (تاريخ/ملفات مستخدمة)، شيت
    'الكل' مع فلاتر وألوان لكل حالة، شيت 'عملاء يجب المرور عليهم' (لو عمود
    التجاوز متاح)، وشيتات منفصلة لكل حالة."""
